...
public class QCommentEntity extends EntityPathBase<CommentEntity> {
    ...
    private static final long serialVersionUID = -351541876L;
    ...
    public QCommentEntity(Class<? extends CommentEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new org.example.post.repository.entity.post.QPostEntity(forProperty("post"), inits.get("post")) : null;
    }
